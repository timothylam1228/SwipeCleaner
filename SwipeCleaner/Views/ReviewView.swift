        ...
        NavigationStack {
                        ...
                        LazyVGrid(columns: columns, spacing: 3) {
                            ForEach(
                                ...
                                PhotoImageView(
                                    ...
                                    contentMode: .fill,
                                    targetSize: library.thumbnailTargetSize
                                )
            ...
            .safeAreaInset(edge: .bottom) {
                if !library.deletionQueue.isEmpty {
                    Button(role: .destructive) {
                        ...
                        Label(
                            "Delete \(library.deletionQueue.count) Photos",
            ...
            .confirmationDialog(
                ...
                Button(
                    ...
                    Task {
                        if await library.deleteQueuedPhotos() {
                            dismiss()
                        }
                    }
                }
                ...
                Text(
                    "Apple will ask you to confirm. Deleted photos move to Recently Deleted in Photos."
                )
            }
            .alert(
                "Deletion Not Completed",
                isPresented: Binding(
                    get: { library.deletionErrorMessage != nil },
                    set: {
                        if !$0 {
                            library.deletionErrorMessage = nil
                        }
                    }
                )
            ) {
                ...
                Text(library.deletionErrorMessage ?? "Unknown error")
            }
        }
    }
}
